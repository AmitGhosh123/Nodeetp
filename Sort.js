// Q. Create a node.js web server application with the HTTP module to perform sort
// operations on a given set of values. Accept a series of values from the input text
// fields of the client page and provide the output values as a response with the
