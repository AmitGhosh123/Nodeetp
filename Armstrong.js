// Q. Create a node.js web server application with the HTTP module to produce a
// series of Armstrong numbers up to a given number. Accept a number from the input
// text field of the client page and provide the output values as a response with the
