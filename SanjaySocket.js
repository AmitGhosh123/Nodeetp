// Implement a client-server application with the express, HTTP, and socket.io
// modules to display the student (your) details in the server console after getting a
// request (connection) from a client. Then Trigger events from the server to display
// a series of even numbers after every 2 seconds on the client web page. Finally,
// display Thank you in the server console with the termination of connect from the
// client.
